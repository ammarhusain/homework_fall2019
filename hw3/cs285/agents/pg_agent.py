...
class PGAgent(BaseAgent):
    ...
    def calculate_q_vals(self, rews_list):
        ...
        # Case 2: reward-to-go PG
            ...
            q_values = np.concatenate([self.discounted_cumsum(r) for r in rews_list])
        return q_values
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        # pass obs into the neural network that you're using to learn the baseline
        # advantage should be [Q-b]
        if self.nn_baseline:
