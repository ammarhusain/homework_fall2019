...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        rand_idcs = np.random.permutation(self.obs.shape[0])[:batch_size] #AH orginal: np.random.permutation(batch_size)
        return self.obs[rand_idcs], self.acs[rand_idcs], self.rews[rand_idcs], self.next_obs[rand_idcs], self.terminals[rand_idcs]
